...
DEFAULT_GAME_CONFIGS_FOR_COMBINATION: GameConfigs = {
    ...
    "titles": ["新手"], "monster_achievements_list": ["新秀"], "element_nicknames": {"火": {"普通": ["炎魂獸"]}},
    ...
    "absorption_config": {}, "cultivation_config": { "skill_exp_base_multiplier": 100, "new_skill_chance": 0.1, "skill_exp_gain_range": (10,30), "max_skill_level": 5, "new_skill_rarity_bias": {"普通": 0.6, "稀有": 0.3, "菁英": 0.1} },
...
def combine_dna_service(dna_objects_from_request: List[Dict[str, Any]], game_configs: GameConfigs, player_data: PlayerGameData, player_id: str) -> Optional[Dict[str, Any]]:
    ...
    if recipe_doc.exists:
        ...
        if not possible_nicknames: possible_nicknames = [primary_element]
        ...
        new_recipe_entry = { "combinationKey": combination_key, "resultingMonsterData": standard_monster_data, "creationTimestamp": int(time.time()), "discoveredByPlayerId": player_id }
