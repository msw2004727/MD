...
function updateMonsterInfoModal(monster, gameConfigs) {
    ...
    // --- FIX: Logic to correctly display buffs ---

    const gains = monster.cultivation_gains || {};
    // FIX #1: Restored original getGainHtml to use inline style for green color
    ...
    // FIX #2: Modified getTitleBuffHtml to use inline style for red color
